...
type LabelerLister interface {
	...
	List(selector labels.Selector) (ret []*clusteropsv1alpha1.Labeler, err error)
...
type labelerLister struct {
	listers.ResourceIndexer[*clusteropsv1alpha1.Labeler]
}

// NewLabelerLister returns a new LabelerLister.
func NewLabelerLister(indexer cache.Indexer) LabelerLister {
	return &labelerLister{listers.New[*clusteropsv1alpha1.Labeler](indexer, clusteropsv1alpha1.Resource("labeler"))}
}

// Labelers returns an object that can list and get Labelers.
func (s *labelerLister) Labelers(namespace string) LabelerNamespaceLister {
	return labelerNamespaceLister{listers.NewNamespaced[*clusteropsv1alpha1.Labeler](s.ResourceIndexer, namespace)}
}
...
type LabelerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*clusteropsv1alpha1.Labeler, error)
