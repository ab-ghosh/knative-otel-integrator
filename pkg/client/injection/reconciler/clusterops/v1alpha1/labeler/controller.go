...
const (
	defaultControllerAgentName = "labeler-controller"
	defaultFinalizerName       = "labelers.clusterops.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	labelerInformer := labeler.Get(ctx)

	lister := labelerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "clusterops.io.Labeler"),
	)
